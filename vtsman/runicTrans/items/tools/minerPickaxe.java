...
public class minerPickaxe extends ItemPickaxe implements ISpecial {
	int maxCap = 1000;
	
	boolean special = true;
	@Override
	public void registerIcons(IconRegister ir) {
		this.itemIcon = ir.registerIcon("runeTrans:cavepick");
	}
	...
	public minerPickaxe(int par1, EnumToolMaterial par2EnumToolMaterial) {
