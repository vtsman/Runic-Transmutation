...
public class modBlocks {
	...
	public static Block chargeNode = new cNode(752, Material.rock).setCreativeTab(tabs.tabRune);
	public static Block rune = new rune(751, Material.rock).setCreativeTab(tabs.tabRune);
	public static void init(){
		GameRegistry.registerTileEntity(capacitorTE.class, "Runic Capacitor");
		GameRegistry.registerTileEntity(vtsman.runicTrans.TE.chargeNode.class, "Charge Node");
		GameRegistry.registerTileEntity(transRuneTE.class, "Transmutation Rune");
		...
		GameRegistry.registerBlock(chargeNode, vtsman.runicTrans.items.itemChargeNode.class, "charge Node");
